import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, b as Skeleton, u as useNavigate } from "./index-C8YmDU4M.js";
import { u as useProducts, a as Battery, B as Badge } from "./use-products-CyqFD06-.js";
...
function CategoryIcon({ category }) {
  ...
  const Icon = (config == null ? void 0 : config.icon) ?? Package;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-8 h-8 text-accent", strokeWidth: 1.5 });
}
function ProductCard({ product, index }) {
  const navigate = useNavigate();
  const catConfig = CATEGORIES.find((c) => c.value === product.category);
  const gradient = CATEGORY_GRADIENTS[product.category] ?? "from-muted to-muted/40";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-card/60 backdrop-blur-sm flex items-center justify-center border border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryIcon, { category: product.category }) }) }),
              product.price && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 right-3 bg-primary text-primary-foreground text-xs font-semibold px-2.5 py-1 rounded-full shadow-sm", children: product.price })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-4 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-base leading-snug line-clamp-2 min-w-0", children: product.name }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: (catConfig == null ? void 0 : catConfig.label) ?? product.category
              }
            ),
            product.wattage && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs border-border", children: product.wattage })
          ] }),
          product.brand && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium tracking-wide uppercase", children: product.brand }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed line-clamp-3 flex-1", children: product.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
              ...
              children: "Enquire Now — चौकशी करा"
            }
          )
        ] })
      ]
...
function ProductSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl overflow-hidden flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-44 rounded-none" }),
...
function Products() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-primary-foreground py-14 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h1,
        {
          ...
          children: "Solar Products Catalog"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "Premium solar panels, inverters, batteries & complete systems — सर्व ब्रँड्स उपलब्ध"
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-10 space-y-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-lg mx-auto", "data-ocid": "product-search", children: [
        ...
        "div",
        {
          ...
          children: CATEGORIES.map(({ value, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium border transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${activeCategory === value ? "bg-accent text-accent-foreground border-accent shadow-sm" : "bg-card text-foreground border-border hover:border-accent/60 hover:bg-accent/10"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3.5 h-3.5", strokeWidth: 2 }),
      ...
      !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center", children: filtered.length === 0 ? "" : `${filtered.length} उत्पाद${filtered.length !== 1 ? "े" : ""} सापडले` }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: ["s1", "s2", "s3", "s4", "s5", "s6"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductSkeleton, {}, k)) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground", children: "कोणतेही उत्पाद सापडले नाही" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs", children: 'Try a different search term or select "सर्व उत्पादने" to see all products.' }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "button",
                ...
                children: "फिल्टर साफ करा — Clear Filters"
              }
            )
          ]
        },
        "empty"
      ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: filtered.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product, index: i }, product.id)) })
    ] })
  ] });
}
export {
