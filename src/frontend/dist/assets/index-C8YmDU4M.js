const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-BvtsGLKl.js","assets/use-products-CyqFD06-.js","assets/useQuery-BrONQZhO.js","assets/card-DzYjPdTo.js","assets/zap-Sbww-niv.js","assets/Products-Dsz9pepz.js","assets/input-xJR-gQvp.js","assets/Book-D6CB_0ae.js","assets/use-leads-uvR90uvz.js","assets/Admin-CpOheaMS.js"])))=>i.map(i=>d[i]);
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-accent shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-5 w-5 text-accent-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-base", children: "Udayasham Solar Tech" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/60", children: "उदयशाम सोलर टेक" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/70 leading-relaxed mb-4", children: "Delivering clean, affordable solar energy solutions for homes and businesses across India. भारतभर स्वच्छ ऊर्जा." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-accent uppercase tracking-wider", children: "Proudly Indian · Powering Progress" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-sm uppercase tracking-wider mb-4 text-primary-foreground/50", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: FOOTER_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: link.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-sm uppercase tracking-wider mb-4 text-primary-foreground/50", children: "Our Services · सेवा" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: SERVICES.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "li",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-sm uppercase tracking-wider mb-4 text-primary-foreground/50", children: "Contact · संपर्क" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex flex-col gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-accent mt-0.5 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-primary-foreground/80 group-hover:text-accent transition-colors duration-200", children: "+91 9158813097" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/40", children: "Primary" })
                    ] })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-accent mt-0.5 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-primary-foreground/80 group-hover:text-accent transition-colors duration-200", children: "+91 7875612771" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/40", children: "Support" })
                    ] })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-accent mt-0.5 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-primary-foreground/80 group-hover:text-accent transition-colors duration-200 break-all", children: "udayahambg@gmail.com" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-accent mt-0.5 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-primary-foreground/70", children: "Pan-India Service · संपूर्ण भारत" })
              ] })
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container flex flex-col sm:flex-row items-center justify-between py-4 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary-foreground/50", children: [
            "© ",
            year,
            " Udayasham Solar Tech. All rights reserved."
          ] }),
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-primary-foreground/10 bg-primary/90", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container flex items-center justify-between py-1.5 text-xs text-primary-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "भारतभर सेवा · Pan-India Service" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 ml-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+91 9158813097" })
                ]
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3 w-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+91 7875612771" })
                ]
              }
            )
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-16 items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/",
              ...
              "data-ocid": "site-logo",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-full bg-accent shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-5 w-5 text-accent-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-primary-foreground text-base tracking-tight", children: "Udayasham Solar Tech" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-primary-foreground/60 tracking-wider uppercase", children: "उदयशाम सोलर टेक" })
                ] })
              ]
            }
          ),
              ...
              children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  className: [
                    ...
                    isActive(link.to) ? "bg-primary-foreground/15 text-accent" : "text-primary-foreground/80 hover:bg-primary-foreground/10 hover:text-primary-foreground"
                  ].join(" "),
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container flex flex-col gap-1 pt-3", children: [
              NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  className: [
                    ...
                    isActive(link.to) ? "bg-primary-foreground/15 text-accent" : "text-primary-foreground/80 hover:bg-primary-foreground/10"
                  ].join(" "),
                  "data-ocid": `mobile-nav-${link.label.toLowerCase().replace(/\s+/g, "-")}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: link.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-primary-foreground/50", children: link.marathi })
                  ]
                },
                link.to
              )),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-full bg-accent text-accent-foreground hover:bg-accent/90 font-semibold", children: "Request Quote — कोटेशन मागवा" })
                }
              )
            ] })
          }
...
const Home = reactExports.lazy(() => __vitePreload(() => import("./Home-BvtsGLKl.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const Products = reactExports.lazy(() => __vitePreload(() => import("./Products-Dsz9pepz.js"), true ? __vite__mapDeps([5,1,2,6,4]) : void 0));
const Book = reactExports.lazy(() => __vitePreload(() => import("./Book-D6CB_0ae.js"), true ? __vite__mapDeps([7,6,8,2,4]) : void 0));
const Admin = reactExports.lazy(() => __vitePreload(() => import("./Admin-CpOheaMS.js"), true ? __vite__mapDeps([9,3,8,2]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 p-8 max-w-4xl mx-auto mt-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 mt-6", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 rounded-lg" }, i)) })
  ] });
}
